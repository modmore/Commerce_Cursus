...
if (!createObject('modNamespace',array(
    'name' => 'commerce_cursus',
    'path' => $componentPath.'/core/components/commerce_cursus/',
    'assets_path' => $componentPath.'/assets/components/commerce_cursus/',
),'name', false)) {
    echo "Error creating namespace commerce_cursus.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_cursus.core_path',
    'value' => $componentPath.'/core/components/commerce_cursus/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_cursus',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_cursus.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_cursus.assets_path',
    'value' => $componentPath.'/assets/components/commerce_cursus/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_cursus',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_cursus.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_cursus/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_cursus.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_cursus',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_cursus.assets_url setting.\n";
}
...
include $componentPath . '/core/components/commerce_cursus/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_cursus/src/';
